<template>
  ...
  >
    ...
    >
      <!-- 2025-01-13: 只读模式提示 -->
      <div v-if="chatStore.isReadOnly" class="text-center text-gray-500 text-sm py-2">
      ...
      <!-- 正常输入框 -->
      <form v-else @submit.prevent="handleSubmit" class="relative flex items-center h-full">
        <input

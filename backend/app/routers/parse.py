...
async def test_polish_content(request_id: int):
    ...
    try:
        ...
        try:
            ...
            raise HTTPException(status_code=400, detail=f"润色内容JSON解析失��: {str(e)}")
